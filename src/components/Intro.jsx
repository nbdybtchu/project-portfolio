...
const Intro = () => {
  ...
  return (
    <>
      ...
      <div className="intro-text text-[#d5d5d5] text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl font-sans font-extrabold bg-[#121212] p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
          <h1 className="hide">
